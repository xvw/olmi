...
(* OASIS_START *)
(* DO NOT EDIT (digest: c349e7ab5af896b2d3186608af310c2a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/xvw/olmi";
          bugreports = None;
          synopsis = "Provide interface for monads in OCaml.";
          description =
            Some
              [
                 OASISText.Para
                   "This library provide functor to create monadic combinators"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Olmi"; "OlmiInterfaces"; "OlmiMake"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "olmi";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/olmi";
                      doc_title = "Documentation and API reference for Olmi";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some ".\005ix\017\221\158\0242\1996\006\254\228_\156";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
